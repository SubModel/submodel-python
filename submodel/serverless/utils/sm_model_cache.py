...
def resolve_model_cache_path_from_hugginface_repository(
    ...
    /,
    path_template: str = "/submodel/cache/{model}/{revision}",  # TODO: Should we just hardcode this?
    ...
    Args:
        ...
        path_template (str, optional): Template string for the cache path. Must contain {model}
                                     and {revision} placeholders. Defaults to "/submodel/cache/{model}/{revision}".
    ...
    Examples:
        ...
        "/submodel/cache/runwayml/stable-diffusion-v1-5/experimental"
        >>> resolve_model_cache_path_from_hugginface_repository("runwayml/stable-diffusion-v1-5")
        "/submodel/cache/runwayml/stable-diffusion-v1-5/main"
