"""
SubModel | API Wrapper | CTL Commands
"""
...
def create_pod(
    ...
    volume_mount_path: str = "/submodel-volume",
    ...
    >>> # Create CPU pod
    >>> pod_id = submodel.create_pod("test", "submodel/stack")
    >>> # Create CPU pod on specific instance
    >>> pod_id = submodel.create_pod("test", "submodel/stack", instance_id="cpu3c-2-4")
    """
    # Input Validation
