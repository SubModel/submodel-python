...
from submodel.api.ctl_commands import get_user, update_user_settings

SSH_FILES = os.path.expanduser("~/.submodel/ssh")
...
def add_ssh_key(public_key):
    """Add an SSH public key to the current user's SubModel account.
