...
from submodel import create_pod
from submodel import error as sm_error
from submodel import get_endpoints, get_pods
...
def load_project_config():
    ...
    project_config_file = os.path.join(os.getcwd(), "submodel.toml")
    if not os.path.exists(project_config_file):
        raise FileNotFoundError("submodel.toml not found in the current directory.")
