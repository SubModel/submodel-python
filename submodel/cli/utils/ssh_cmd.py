...
from .sm_info import get_pod_ssh_ip_port
from .sm_submodelignore import get_ignore_list
from .sm_userspace import find_ssh_key_file
...
class SSHConnection:
    ...
    def rsync(self, local_path, remote_path, quiet=False):
        ...
        A .submodelignore file can be used to ignore files and directories.
