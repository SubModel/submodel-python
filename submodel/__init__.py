""" Allows submodel to be imported as a module. """
...
from .serverless.modules.sm_logger import SubModelLogger
from .version import __version__

# ------------------------------- Config Paths ------------------------------- #
SSH_KEY_PATH = os.path.expanduser("~/.submodel/ssh")
...
endpoint_url_base = os.environ.get(
    "SUBMODEL_ENDPOINT_BASE_URL", "https://api.submodel.ai/v1"
