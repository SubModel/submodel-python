"""Tests for submodel.cli.utils.sm_sync module."""

import time
import unittest
from unittest.mock import ANY, MagicMock, patch

from submodel.cli import STOP_EVENT
from submodel.cli.utils.sm_sync import WatcherHandler, start_watcher, sync_directory


class TestWatcherHandler(unittest.TestCase):
    """Tests for the WatcherHandler class."""

    @patch("submodel.cli.utils.sm_sync.should_ignore")
...
class TestSyncDirectory(unittest.TestCase):
    ...
    @patch("submodel.cli.utils.sm_sync.threading.Thread")
    @patch("submodel.cli.utils.sm_sync.start_watcher")
...
class TestStartWatcher(unittest.TestCase):
    ...
    @patch("submodel.cli.utils.sm_sync.Observer")
    @patch("submodel.cli.utils.sm_sync.WatcherHandler")
    def test_start_watcher(self, mock_watch_handler, mock_observer_class):
        ...
        STOP_EVENT.clear()
        with patch("submodel.cli.utils.sm_sync.time.sleep") as mock_sleep:
