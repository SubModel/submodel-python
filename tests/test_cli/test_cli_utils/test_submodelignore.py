""" Unit tests for the submodelignore module in the cli.utils package. """
...
from submodel.cli.utils.sm_submodelignore import get_ignore_list, should_ignore
...
class TestShouldIgnoreFunction(unittest.TestCase):
    ...
    @patch("submodel.cli.utils.sm_submodelignore.get_ignore_list")
    ...
    @patch("submodel.cli.utils.sm_submodelignore.os.getcwd")
