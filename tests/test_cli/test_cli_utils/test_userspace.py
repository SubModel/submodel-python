""" Unit testing for submodel.cli.utils.sm_userspace.py """

import os
import unittest
from unittest.mock import patch

from submodel.cli.utils.sm_userspace import find_ssh_key_file
...
class TestFindSSHKeyFile(unittest.TestCase):
    ...
    def test_valid_key_found(self, mock_listdir, mock_isfile, mock_ssh_client):
        ...
        result = find_ssh_key_file(self.pod_ip, self.pod_port)
        self.assertEqual(result, os.path.expanduser("~/.submodel/ssh/key1"))
