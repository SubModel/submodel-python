""" Unit testing for submodel.cli.utils.sm_info.py """

from unittest.mock import patch

import pytest

from submodel.cli.utils.sm_info import get_pod_ssh_ip_port
...
class TestGetPodSSHIpPort:
    ...
    def test_get_pod_ssh_ip_port_normal(self):
        ...
        with patch("submodel.cli.utils.sm_info.get_pod") as mock_get_pod:
