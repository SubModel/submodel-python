...
from submodel import error as sm_error
from submodel.cli.groups.project.helpers import (
    attempt_pod_launch,
    copy_template_files,
...
class TestHelpers(unittest.TestCase):
    ...
    @patch("submodel.cli.groups.project.helpers.get_pods")
    ...
    @patch("submodel.cli.groups.project.helpers.get_endpoints")
    ...
    @patch("submodel.cli.groups.project.helpers.create_pod")
    def test_attempt_pod_launch_success(self, mock_create_pod):
        ...
        mock_create_pod.side_effect = sm_error.QueryError("error")
