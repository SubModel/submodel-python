""" Unit tests for the submodel.cli.groups.exec.helpers module. """

import unittest
from unittest.mock import mock_open, patch

from submodel.cli.groups.exec.helpers import POD_ID_FILE, get_session_pod
...
class TestGetSessionPod(unittest.TestCase):
    ...
    @patch("submodel.cli.groups.exec.helpers.get_pod")
