...
from submodel.cli.groups.config import functions
...
class TestConfig(unittest.TestCase):
    ...
    @patch("submodel.cli.groups.config.functions.toml.load")
    ...
    def test_set_credentials(self, mock_file, mock_toml_load):
        ...
        functions.set_credentials("SUBMODEL_API_KEY")
    ...
    @patch("builtins.open", new_callable=mock_open())
    @patch("submodel.cli.groups.config.functions.toml.load")
    @patch("submodel.cli.groups.config.functions.os.path.exists")
