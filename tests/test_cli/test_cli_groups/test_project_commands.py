"""
SubModel | CLI | Groups | Project | Commands | Tests
"""
...
from submodel.cli.groups.project.commands import (
    deploy_project,
    new_project_wizard,
    start_project_pod,
)
...
class TestProjectCLI(unittest.TestCase):
    ...
    def test_new_project_wizard_no_network_volumes(self):
        ...
        """
        with patch("submodel.cli.groups.project.commands.get_user") as mock_get_user:
    ...
    def test_new_project_wizard_success(self):
        ...
        with patch("click.prompt") as mock_prompt, patch(
            ...
            "submodel.cli.groups.project.commands.create_new_project"
        ) as mock_create, patch(
            "submodel.cli.groups.project.commands.get_user"
        ) as mock_get_user, patch(
            "submodel.cli.groups.project.commands.cli_select"
        ) as mock_select:
    ...
    def test_start_project_pod(self):
        ...
        with patch("click.confirm", return_value=True) as mock_confirm, patch(
            "submodel.cli.groups.project.commands.start_project"
        ) as mock_start:
    ...
    @patch("submodel.cli.groups.project.commands.click.echo")
    @patch("submodel.cli.groups.project.commands.create_project_endpoint")
    def test_deploy_project(self, mock_create_project_endpoint, mock_click_echo):
        ...
        mock_click_echo.assert_any_call(
            "    - https://api.submodel.ai/v1/sl/test_endpoint_id/runsync"
        )
        mock_click_echo.assert_any_call(
            "    - https://api.submodel.ai/v1/sl/test_endpoint_id/run"
        )
        mock_click_echo.assert_any_call(
            "    - https://api.submodel.ai/v1/sl/test_endpoint_id/health"
        )
