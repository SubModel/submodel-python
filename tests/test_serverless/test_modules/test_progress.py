"""
Tests for the sm_progress.py module.
"""
...
from submodel.serverless.modules.sm_progress import _thread_target, progress_update


class TestProgressUpdate(unittest.TestCase):
    """Tests for the progress_update function."""

    @patch("submodel.serverless.modules.sm_progress.send_result")
    @patch("submodel.serverless.modules.sm_progress._thread_target")
