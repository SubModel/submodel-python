...
from submodel.serverless.modules.worker_state import (
    Job,
    JobsProgress,
    IS_LOCAL_TEST,
    WORKER_ID,
...
class TestEnvVars(unittest.TestCase):
    ...
    def setUp(self):
        ...
        os.environ["SUBMODEL_AI_API_KEY"] = self.test_api_key

    def test_is_local_test(self):
        """
        Tests if IS_LOCAL_TEST flag is properly set
        """
        os.environ.pop("SUBMODEL_WEBHOOK_GET_JOB", None)
    ...
    def test_worker_id(self):
        ...
        """
        os.environ["SUBMODEL_POD_ID"] = WORKER_ID

        self.assertEqual(WORKER_ID, os.environ.get("SUBMODEL_POD_ID"))
