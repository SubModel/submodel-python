""" Tests for submodel.serverless.modules.sm_tips.py """

import unittest
from unittest.mock import patch

from submodel.serverless.modules.sm_tips import check_return_size


class TestTips(unittest.TestCase):
    """Tests for the Tips module"""

    @patch("submodel.serverless.modules.sm_tips.log.tip")
