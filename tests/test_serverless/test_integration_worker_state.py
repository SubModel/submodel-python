...
This test mimics the submodel.serverless.worker.run_worker path.
"""
...
from submodel.serverless.modules.sm_scale import JobScaler
from submodel.serverless.modules.worker_state import JobsProgress
...
class TestWorkerStateIntegration:
    ...
    def setup_method(self):
        ...
        self.env_patcher = patch.dict(os.environ, {
            'SUBMODEL_AI_API_KEY': 'test_key',
            'SUBMODEL_POD_ID': 'test_pod_id',
            'SUBMODEL_WEBHOOK_PING': 'http://test.com/ping',
        ...
        self.state_file_patcher = patch.object(JobsProgress, '_STATE_FILE', 
                                               os.path.join(self.temp_dir, '.submodel_jobs.pkl'))
