...
from submodel.serverless.utils import (
    sm_upload,
    upload_file_to_bucket,
    upload_in_memory_object,
)
from submodel.serverless.utils.sm_upload import get_boto_client
...
class TestBotoConfig(unittest.TestCase):
    ...
    def test_get_boto_client(self):
        ...
        with patch("boto3.session.Session") as mock_session, patch(
            "submodel.serverless.utils.sm_upload.TransferConfig"
    ...
    def test_get_boto_client_environ(self):
        ...
        """
        assert sm_upload.get_boto_client()[0] is None
        ...
        with patch("boto3.session.Session") as mock_session, patch(
            ...
            boto_client, transfer_config = sm_upload.get_boto_client()
...
class TestUploadImage(unittest.TestCase):
    ...
    @patch("submodel.serverless.utils.sm_upload.get_boto_client")
    @patch("builtins.open")
    @patch("submodel.serverless.utils.sm_upload.os.makedirs")
    def test_upload_image_local(self, mock_makedirs, mock_open, mock_get_boto_client):
        ...
        result = sm_upload.upload_image("job_id", "image_location")
