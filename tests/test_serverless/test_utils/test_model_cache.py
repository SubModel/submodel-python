...
from submodel.serverless.utils.sm_model_cache import (
    resolve_model_cache_path_from_hugginface_repository,
)


class TestModelCache(unittest.TestCase):
    """Tests for sm_model_cache"""
    ...
    def test_with_revision(self):
        ...
        self.assertEqual(
            path, "/submodel/cache/runwayml/stable-diffusion-v1-5/experimental"
        )
    ...
    def test_without_revision(self):
        ...
        self.assertEqual(path, "/submodel/cache/runwayml/stable-diffusion-v1-5/main")
