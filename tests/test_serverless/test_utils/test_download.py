"""Tests for submodel | serverless | modules | download.py"""
...
from submodel.serverless.utils.sm_download import (
...
class TestDownloadFilesFromUrls(unittest.TestCase):
    ...
    @patch("submodel.http_client.SyncClientSession.get", side_effect=mock_requests_get)
...
class FileDownloaderTestCase(unittest.TestCase):
    ...
    @patch("submodel.serverless.utils.sm_download.SyncClientSession.get")
    @patch("builtins.open", new_callable=mock_open)
    ...
    @patch("submodel.serverless.utils.sm_download.SyncClientSession.get")
    @patch("builtins.open", new_callable=mock_open)
    @patch("submodel.serverless.utils.sm_download.zipfile.ZipFile")
