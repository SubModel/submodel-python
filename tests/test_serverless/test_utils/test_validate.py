""" Tests for submodel.serverless.utils.validate """

import unittest
from unittest.mock import Mock

from submodel.serverless.utils import sm_validator
...
class TestValidator(unittest.TestCase):
    ...
    def test_validate_success(self):
        ...
        Tests validate
        """
        result = sm_validator.validate(self.raw_input, self.schema)
    ...
    def test_validate_rules_not_dict(self):
        ...
        """
        result = sm_validator.validate(self.raw_input, {"x": "not dict"})
        self.assertIn("errors", result)
