...
from submodel.serverless.utils import sm_debugger
from submodel.serverless.utils.sm_debugger import (
    Checkpoints,
    FunctionTimer,
    LineTimer,
...
class TestDebugger(unittest.TestCase):
    ...
    @patch("submodel.serverless.utils.sm_debugger.cpuinfo.get_cpu_info")
    def test_key_error(self, mock_get_cpu_info):
        ...
        importlib.reload(sm_debugger)

        assert mock_get_cpu_info.called
        self.assertEqual(sm_debugger.PROCESSOR, "Unable to get processor info.")
